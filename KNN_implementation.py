...
class TestingSoftware():
    ...
    def checkAnswer(self,user_sign):
        ...
        if self.desired_letter >= len(self.desired_sentence):
            ...
            return
        if self.desired_sentence[self.desired_letter] == " " or self.desired_sentence[self.desired_letter] == "." or self.desired_sentence[self.desired_letter] == "" or self.desired_sentence[self.desired_letter] == "!" or self.desired_sentence[self.desired_letter] == ",":
