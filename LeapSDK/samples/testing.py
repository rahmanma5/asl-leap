...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        for hand in frame.hands:
            ...
            temp = []
            for i in range(0,4): # should be 5
                for j in range(0,4):
                    for k in range(1,4):
                        for l in range(0,3):
            ...
            # for x in range(0,4):
            #     for i in range(0,4):
            #         currentFinger = handCapture[x]
            #         temp.append(str(currentFinger[i][0]))
            #         for j in range(1,4):
            #             for k in range(1,3):
            #                 temp.append(str(currentFinger[i][j][k]))
            print len(temp)
            # print handCapture[0][0][0]
            # print handCapture[0][0][1]
            # print handCapture[0][0][2]
            # print handCapture[0][0][3]

            # print handCapture[0][1][0]
            # print handCapture[0][1][1]
            # print handCapture[0][1][2]
            # print handCapture[0][1][3]

            # print handCapture[1][0][0]
            # print handCapture[1][0][1]
            # print handCapture[1][0][2]
            # print handCapture[1][0][3]

            # print handCapture[4][0][0]
            # print handCapture[4][0][1]
            # print handCapture[4][0][2]
            # print handCapture[4][0][3]
